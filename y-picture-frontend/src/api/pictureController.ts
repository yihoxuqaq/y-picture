...
/** pictureEditByBatch POST /api/cos/edit_picture/batch */
export async function pictureEditByBatchUsingPost(
  body: API.PictureEditByBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/cos/edit_picture/batch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureVOByPageWithCache POST /api/cos/list/page/vo/cache */
export async function listPictureVoByPageWithCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/cos/list/page/vo/cache', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** createPictureOutPaintingTask POST /api/cos/out_painting/create_task */
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.BaseResponseCreateOutPaintingTaskResponse_>(
    '/api/cos/out_painting/create_task',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
/** getPictureOutPaintingTask GET /api/cos/out_painting/get_task */
export async function getPictureOutPaintingTaskUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPictureOutPaintingTaskUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseGetOutPaintingTaskResponse_>('/api/cos/out_painting/get_task', {
    method: 'GET',
    params: {
      ...params,
    },
