...
export async function editPictureUsingPost(
  ...
  return request<API.BaseResponseBoolean_>('/api/picture/editPicture', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureByPage POST /api/picture/list */
export async function listPictureByPageUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePicture_>('/api/picture/list', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureVOByPage POST /api/picture/list/vo */
export async function listPictureVoByPageUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
