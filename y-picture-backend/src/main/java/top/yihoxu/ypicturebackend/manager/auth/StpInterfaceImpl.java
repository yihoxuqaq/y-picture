package top.yihoxu.ypicturebackend.manager.auth;
...
import top.yihoxu.ypicturebackend.enums.SpaceRoleEnum;
...
import top.yihoxu.ypicturebackend.manager.auth.model.SpaceUserAuthContext;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (loginUser == null) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "用户为登录");
        }
        ...
        //如果没有spaceUserId，通过尝试spaceId，或pictureId获取Space对象并处理
        ...
        if (spaceId == null) {
            ...
            Picture picture = pictureService.lambdaQuery()
                    ...
                    .one();
            if (picture == null) {
                throw new BusinessException(ErrorCode.NOT_FOUND_ERROR, "为找到图片信息");
            }
